function CMenu(){
    ...
    this._init = function(){
        ...
        var oLogo = new CRummyAnim(CANVAS_WIDTH/2,CANVAS_HEIGHT/2-100,s_oStage);
        oLogo.show(true);
        
        _oButPlay = new CGfxButton(CANVAS_WIDTH/2,CANVAS_HEIGHT/2 + 250,s_oSpriteLibrary.getSprite('but_play'),s_oStage);
